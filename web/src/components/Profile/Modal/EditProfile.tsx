...
const EditProfile = ({ user, onSave, onClose }: EditProfileProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full sm:max-w-xl bg-white rounded-xl overflow-hidden animate-fadeIn">
        ...
        <div className="relative flex justify-center -mt-12">
          <div className="w-24 h-24 rounded-full border-4 border-white overflow-hidden relative">
            ...
            <button
              ...
              className="absolute bottom-1 right-1 bg-black/50 text-white p-1 rounded-full hover:bg-black/70"
            >
              <FaCamera size={14} />
            </button>
            <input
        ...
        <div className="px-5 py-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1 w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none resize-none"
            />
          </div>
