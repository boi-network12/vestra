...
const Users = () => {
  ...
  const renderHeader = () => {
    return (
      <div className="w-full fixed top-0 z-10 bg-white/30 dark:bg-gray-800/30 backdrop-blur-md shadow-sm flex items-center justify-between px-5 py-3">
        <Link href="/home">
          <Image
            src={LogoImage}
            alt="vestra image"
        ...
        <div className="relative w-full max-w-md ml-4">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 outline-none text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-300"
          />
        </div>
      </div>
    );
